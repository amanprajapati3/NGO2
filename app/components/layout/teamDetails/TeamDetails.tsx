...
export default function TeamDetails({ data }: TeamDetailsProps) {
  ...
  const statIcons = [
    ...
    <CheckCircle key="projects" className="w-5 h-5 text-orange-500 mb-1 mx-auto" />,
      ...
      <section className="py-10 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div className="lg:col-span-5 relative group">
              <div className="relative rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
                ...
                <div className="grid absolute bottom-4 left-4 right-4 rounded-xl grid-cols-3 divide-x divide-slate-800 bg-slate-950/70 backdrop-blur-sm text-white p-4 sm:p-5 text-center shadow-lg border border-slate-800/50">
                  {stats?.map((stat, idx) => (
                    <div key={idx} className="px-2 flex flex-col items-center justify-center">
          ...
          <div className="pt-0">
            ...
            {/* <div className="relative flex items-center justify-between my-8 px-4 sm:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {experience?.map((exp, idx) => (
                <div
                  key={idx}
                  className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition relative flex flex-col justify-between"
                >
                  <div>
