...
interface CausesSectionExtendedProps extends CausesSectionProps {
                  ...
                  <div className="flex flex-1 flex-col justify-between p-4">
                    ...
                    <div className="md:mt-6 mt-2 flex relative items-center justify-between gap-3 pt-2">
                      ...
                      <Link
                        ...
                        className={`absolute md:left-[40%] left-[50%] -translate-x-1/2 flex w-[60%] md:w-[45%] items-center justify-center gap-2 rounded-full px-5 py-2.5 text-sm font-bold text-white shadow-md transition-all ${bgButtonClass}`}
                      >
        ...
        {cta && (
          <div className="relative mt-12 h-[260px] sm:h-[280px] overflow-hidden bg-[#232042] py-10 text-center text-white shadow-2xl  flex items-center justify-center">
            ...
            <div className="absolute inset-0 pointer-events-none select-none overflow-hidden flex justify-between items-center px-2 sm:px-6">
              ...
              >
                <path
                  d="M 130 -10 Q 100 80 10 160"
                  strokeWidth="3"
                  strokeLinecap="round"
                />
                {/* Left Side Fronds */}
                <path
                  d="M 110 25 Q 70 20 40 30"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
                <path
                  d="M 98 48 Q 58 40 28 55"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 85 72 Q 48 65 18 82"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 70 98 Q 36 92 10 112"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 55 122 Q 26 120 4 140"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
                ...
                {/* Right Side Fronds */}
                <path
                  d="M 120 15 Q 95 40 75 60"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
                <path
                  d="M 108 38 Q 82 65 62 88"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 92 62 Q 68 90 50 112"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 76 88 Q 54 118 38 138"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
              </svg>
              ...
              >
                ...
                />
                <path
                  d="M 48 25 Q 95 20 128 35"
                  stroke="#232042"
                  strokeWidth="2"
                  fill="none"
                />
                <path
                  d="M 58 65 Q 108 65 138 85"
                  stroke="#232042"
                  strokeWidth="2"
                  fill="none"
                />
                <path
                  d="M 68 105 Q 112 112 132 138"
                  stroke="#232042"
                  strokeWidth="2"
                  fill="none"
                />
              ...
              >
                <path
                  d="M 105 210 Q 90 110 10 10"
                  strokeWidth="3"
                  strokeLinecap="round"
                />
                {/* Top Fronds */}
                <path
                  d="M 20 22 Q 55 20 88 32"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
                <path
                  d="M 32 38 Q 66 36 98 52"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 44 58 Q 78 55 108 75"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 56 80 Q 88 78 118 100"
                  strokeWidth="5"
                  strokeLinecap="round"
                />
                <path
                  d="M 68 102 Q 96 105 122 128"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
                ...
                {/* Bottom Fronds */}
                <path
                  d="M 12 15 Q 32 50 52 80"
                  strokeWidth="4"
                  strokeLinecap="round"
                />
                <path
                  d="M 24 35 Q 44 70 64 102"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
                <path
                  d="M 38 58 Q 56 92 74 125"
                  strokeWidth="4.5"
                  strokeLinecap="round"
                />
                <path
                  d="M 52 82 Q 70 118 86 148"
                  strokeWidth="4"
                  strokeLinecap="round"
                />
              </svg>
